...
export function DataTableToolbarSelectedFleet<TData>({
  table,
  ...
  return (
    <div className="flex items-center justify-between">
      <div className="flex flex-1 flex-col-reverse items-start gap-y-2 sm:flex-row sm:items-center sm:space-x-2">
        ...
        {/* <Button
          onClick={() => console.log(table.getRowModel().rows.forEach((r) => (r.original as SuggestedVehicle).isSuggested===true ? r.toggleSelected(): null))  }> Select All Suggeted Vehicle </Button>
        {
